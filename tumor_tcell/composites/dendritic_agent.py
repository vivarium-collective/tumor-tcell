...
This composite model combines the dendritic-cell process with local_field, division, and death.

This composite can be run on its own from the command line.

    $ python tumor_tcell/composites/dendritic_agent.py
...
from tumor_tcell.processes.dendritic_cell import DendriticCellProcess, TIMESTEP
...
class DendriticAgent(Composer):
    ...
    def initialize_processes(self, config):
        self.dendritic_process = DendriticCellProcess(config['dendritic_cell'])
    ...
    def generate_processes(self, config):
        ...
        return {
            'dendritic_cell': self.dendritic_process,
